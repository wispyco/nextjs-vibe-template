  ...
  useEffect(() => {
    ...
    const initializeAuth = async () => {
      try {
        ...
        // Get user credits using ApiClient
        const { data: creditsData, error: creditsError } = await ApiClient.getUserCredits();
        
        if (creditsError) {
          console.error("Error getting user credits:", creditsError);
